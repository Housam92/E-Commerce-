            ...
            <div className="user-address-card my-3 px-2">
                <Row className="d-flex justify-content-between pt-2">
                    <Col xs="6" className="d-flex">
                        ...
                        <div className="p-1 item-delete-edit">Housam Abdallah </div>
                    </Col>
                ...
                <Row className="">
                    <Col xs="12" className="d-flex">
                        ...
                        <div className="p-1 item-delete-edit">housam@gmail.com</div>
                    </Col>
                </Row>
                <Row className="mt-5">
                    <Col xs="10" sm="8" md="6" className="">
                        <div className="admin-content-text"> Edit Password </div>
                        <input
                            type="password"
